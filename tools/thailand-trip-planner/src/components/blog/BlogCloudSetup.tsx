  ...
  return (
    <div className="xhs-cloud-setup">
      ...
      <ol className="mt-2 list-decimal space-y-1.5 pl-4 text-sm text-stone-600">
        ...
        <li>
          SQL Editor 執行{' '}
          <code className="rounded bg-stone-100 px-1 text-xs">tools/thailand-trip-planner/supabase/schema.sql</code>
        </li>
        ...
        <li>重新執行 <code className="rounded bg-stone-100 px-1 text-xs">npm run thailand:dev</code></li>
      </ol>
    </div>
  )
}
