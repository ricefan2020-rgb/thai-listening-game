...
export type ThailandRegionId = 'pattaya' | 'bangkok' | 'chiangmai' | 'phuket' | 'krabi'
...
export const REGION_LABELS: Record<ThailandRegionId, string> = {
  pattaya: '芭提雅',
  bangkok: '曼谷',
  chiangmai: '清邁',
  phuket: '普吉島',
